...
function LeftCategoryMenu() {
  ...
  return (
    <nav className="w-[140px] shrink-0 border-r border-slate-800/40 overflow-y-auto py-2">
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0">
      ...
      {isMultiView ? (
        ...
        <div className="flex-1 relative flex items-center justify-center bg-gradient-to-b from-slate-950 to-slate-900/50 overflow-hidden">
          {/* Dot grid */}
          <div
        ...
        <div className="flex gap-1.5">
          ...
          <button
            ...
            className={cn(
              ...
              busy || disabled
                ? 'bg-slate-800 text-slate-500 cursor-not-allowed'
                : 'bg-gradient-to-r from-amber-600/90 to-orange-600/90 text-white hover:from-amber-500 hover:to-orange-500 shadow-lg shadow-amber-900/20'
            )}
          >
...
function OptionsPanel() {
  ...
  return (
    <div className="w-[260px] shrink-0 border-l border-slate-800/40 flex flex-col min-h-0">
      {/* Search header */}
