 ...
 * Reuses the image upload pattern from AssetAnalysisUploadImage
 */
          ...
          {!selectedFile ? (
            ...
            >
              ...
              <p className="text-gray-500 text-center text-xs mt-1">
                Character portrait or reference image
              </p>
              <input
                type="file"
                ref={fileInputRef}
            ...
            >
              <button
                ...
                className="absolute top-2 right-2 bg-gray-900/80 hover:bg-gray-900
                  text-red-400 hover:text-red-300 rounded-full p-1.5 z-10 transition-all"
                title="Remove image"
              >
                <X size={16} />
              </button>
